...
const Philosophy = () => {
  return (
    <SectionWrapper
      subHeaderTitle={"Vision & Passion"}
      HeaderTitle={"Our Philoshophy"}>
      <div className="px-0">
        <div className="hidden lg:grid grid-cols-3 justify-center items-center gap-2">
          ...
          <div className="mr-auto relative">
            <div className="bg-white w-80 p-3 shadow-md  border flex justify-center items-center rounded-md gap-2 absolute left-[-43px] top-[-80px]">
              ...
              <div>
                ...
                <p className="text-[12px]">
                  All products we use are professional and have proven
                  effeciency.
                </p>
              </div>
            </div>
